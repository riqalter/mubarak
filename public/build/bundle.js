    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p0, "class", "wonder svelte-1vm6p7z");
    			add_location(p0, file, 44, 4, 918);
    			attr_dev(h1, "class", "svelte-1vm6p7z");
    			add_location(h1, file, 45, 4, 948);
    			attr_dev(h2, "class", "svelte-1vm6p7z");
    			add_location(h2, file, 46, 4, 975);
    			attr_dev(p1, "class", "svelte-1vm6p7z");
    			...
    			: "salam") + " svelte-1vm6p7z"));

    			add_location(span, file, 52, 4, 1237);
    			attr_dev(p3, "class", "salam-teks svelte-1vm6p7z");
    			add_location(p3, file, 58, 4, 1440);
    			attr_dev(div, "class", "animate__animated animate__fadeIn svelte-1vm6p7z");
    			add_location(div, file, 43, 2, 865);
    			attr_dev(a0, "href", "https://svelte.dev/");
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "class", "svelte-1vm6p7z");
    			add_location(a0, file, 63, 6, 1607);
    			attr_dev(a1, "href", "https://vercel.com/");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "class", "svelte-1vm6p7z");
    			add_location(a1, file, 64, 17, 1682);
    			attr_dev(p4, "class", "svelte-1vm6p7z");
    			add_location(p4, file, 61, 4, 1539);
    			attr_dev(footer, "class", "svelte-1vm6p7z");
    			add_location(footer, file, 60, 2, 1525);
    			attr_dev(main, "class", "svelte-1vm6p7z");
